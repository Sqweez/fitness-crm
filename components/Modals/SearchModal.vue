<template>
  ...
  <div v-click-outside="() => { $emit('close') }">
    ...
    >
      <div @click="$emit('close')" v-show="modalOpen"
          ...
          <form class="border-b border-gray-200">
            <div class="relative">
              ...
              <button class="absolute inset-0 right-auto group" type="submit" aria-label="Search">
                <svg class="w-4 h-4 shrink-0 fill-current text-gray-400 group-hover:text-gray-500 ml-4 mr-2"
